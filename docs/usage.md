[Project homepage](https://github.com/peter88213/nv_writer) > Instructions for use
...
*Note: If you install novelibre at a later time, you can always install the plugin afterwards by running the nv_writer/ setup script again.*
