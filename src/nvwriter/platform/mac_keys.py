...
class MacKeys(GenericKeys):
    ...
    DECREASE_FONT_SIZE = ('<Command-Option-minus>', 'Cmd-Option--')
    INCREASE_FONT_SIZE = ('<Command-Option-plus>', 'Cmd-Option-+')
    DECREASE_SCREEN_SIZE = ('<Command-minus>', 'Cmd--')
    INCREASE_SCREEN_SIZE = ('<Command-plus>', 'Cmd-+')
