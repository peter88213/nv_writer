...
class GenericKeys:
    ...
    DECREASE_FONT_SIZE = ('<Control-Alt-minus>', f'{_("Ctrl")}-Alt--')
    DECREASE_SCREEN_SIZE = ('<Control-minus>', f'{_("Ctrl")}--')
    END_WRITING_MODE = ('<F11>', 'F11')
    INCREASE_FONT_SIZE = ('<Control-Alt-plus>', f'{_("Ctrl")}-Alt-+')
    INCREASE_SCREEN_SIZE = ('<Control-plus>', f'{_("Ctrl")}-+')
